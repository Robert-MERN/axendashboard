      ...
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:bg-secondary-dark-bg dark:[#484B52] w-400">
        <div className="flex justify-between items-center p-4 ml-4">
          ...
          <button
            ...
            className='text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray dark:hover:bg-main-dark-bg transition-all'
          >
            <MdOutlineCancel />
          </button>
        </div>
        <div className='flex-col border-t-1 border-color p-4 ml-4' >
          <p className='font-semibold text-lg' >Theme Setings</p>
          <div className="mt-4">
            <input
              type="radio"
              id="light"
