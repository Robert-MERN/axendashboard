...
const status = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: `${props.status === "Completed" ? "#8BE78B" : props.status === "Pending" ? "#FEC90F" : props.status === "Active" ? "#8BE78B" : "red"}` }} className="rounded-full h-3 w-3" />
    <p>{props.status}</p>
  </div>
);
const bookingStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: `${props.bookingStatus === "Completed" ? "#8BE78B" : props.bookingStatus === "Pending" ? "#FEC90F" : props.bookingStatus === "Active" ? "#8BE78B" : "red"}` }} className="rounded-full h-3 w-3" />
    <p>{props.bookingStatus}</p>
  </div>
);
const paymentStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: `${props.paymentStatus === "Completed" ? "#8BE78B" : props.paymentStatus === "Pending" ? "#FEC90F" : props.paymentStatus === "Active" ? "#8BE78B" : "red"}` }} className="rounded-full h-3 w-3" />
...
export const customersGrid = [
  ...
  {
    field: 'adults',
    headerText: 'Passenger Type(Adults)',
    width: '200',
    textAlign: 'Center',
  },
  {
    field: 'children',
    headerText: 'Passenger Type(Childrens)',
    width: '220',
    textAlign: 'Center',
  },
  {
    field: 'infants',
    headerText: 'Passenger Type(Infants)',
    width: '200',
    textAlign: 'Center',
  },
  {
...
export const adminLinks = [
...

  {
    ...
    links: [
      {
        name: 'Add Agent',
        icon: <PersonAddAlt1Icon className="scale-75"  />,
        target: "signup",
        required: true
      },
